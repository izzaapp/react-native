...
import { TouchableOpacity, View, Text, ScrollView, RefreshControl, Alert } from "react-native";
  ...
  return (
    <>
      ...
      <ScrollView className="p-4" refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} />}>
        <TouchableOpacity className="p-4 bg-blue-600 rounded-xl" onPress={navigateToCreateorder}>
